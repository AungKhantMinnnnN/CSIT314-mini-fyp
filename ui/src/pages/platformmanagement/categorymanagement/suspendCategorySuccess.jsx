...
import { Ban, CheckCircle, FolderOpen, FileText } from "lucide-react";
import { useLocation, useNavigate } from "react-router-dom";

const SuspendCategorySuccess = () => {
  const navigate = useNavigate();
  const location = useLocation();

  // safely access category object
    ...
    <div className="flex flex-col p-8 bg-gray-50 min-h-screen items-center">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-center">
          The category <span className="font-medium">{category.Name}</span> has been suspended.
        </p>
      </div>
...
export default SuspendCategorySuccess;

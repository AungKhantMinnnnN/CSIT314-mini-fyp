...
import { CheckCircle, IdCard, Mail, User } from "lucide-react";
...
const UpdateSuccess = () => {
    ...
    const user = location.state?.user.updatedUserInfo;
    ...
    <div className="flex flex-col p-8 bg-gray-50 min-h-screen items-center">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-center">
          {user.username}'s information has been successfully updated.
        </p>
      </div>

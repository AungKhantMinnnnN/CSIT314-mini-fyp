...
const UpdateRequestSuccess = () => {
  ...
  // Safely get updated request object from navigation state
    ...
    <div className="flex flex-col p-8 bg-gray-50 min-h-screen items-center">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-center">
          Your request has been updated. CSR representatives will see the latest information.
        </p>
      </div>
...
export default UpdateRequestSuccess;
